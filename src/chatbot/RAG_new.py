...
class MainAgent:
    ...
    def __call__(self, state: State) -> dict:
        ...
        if rag_results:
            print("\n ============= re_rank ============= ")
            print("số lượng tài liệu re_rank:", len(rag_results))
        else:
        ...
        docs_text_memory = [doc.page_content for doc in memory_retrieve_result]
        ...
        rag_memory = "\n".join([doc.page_content for doc in memory_re_rank])
